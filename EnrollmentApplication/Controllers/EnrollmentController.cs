...
namespace EnrollmentApplication.Controllers
{
    public class EnrollmentController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EnrollmentId,IsActive , AssignedCampus,EnrollmentSemester, EnrollmentYear, StudentId,CourseId,Grade")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EnrollmentId,IsActive , AssignedCampus,EnrollmentSemester, EnrollmentYear, StudentId,CourseId,Grade")] Enrollment enrollment)
        {
            if (ModelState.IsValid)
            {
